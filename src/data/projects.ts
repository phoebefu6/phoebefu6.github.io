...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: '50 live courses, one series',
    description:
...
export const shelves: CourseShelf[] = [
  ...
  },
  {
    ...
    liveCount: 6,
    samples: 'GitHub, markdown, diagrams, HTML',
    icon: 'Wrench',
  },
  {
    ...
    liveCount: 2,
    samples: 'Strategic thinking, PMO',
    icon: 'Compass',
  },
]
